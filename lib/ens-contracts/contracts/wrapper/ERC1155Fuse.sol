...
/* This contract is a variation on ERC1155 with the additions of _setData, getData and 
 * _beforeTransfer and ownerOf. _setData and getData allows the use of the other 96 bits 
 * next to the address of the owner for extra data. We use this to store 'fuses' that 
 * control permissions that can be burnt. 32 bits are used for the fuses themselves and 
 * 64 bits are used for the expiry of the name. When a name has expired, its fuses will 
 * be be set back to 0 
 */
